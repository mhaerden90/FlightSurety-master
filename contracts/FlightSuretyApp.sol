...
contract FlightSuretyApp {
    ...
    */
    ...
    function isRegisteredFlight(address airline, string flight, uint256 timestamp) external view returns(bool){
        bytes32 flightKey = getFlightKey(airline, flight, timestamp);
        return flights[flightKey].isRegistered;
    }

    function isInsuredPassenger (address passenger, string flight, uint256 timestamp, address airline) external view returns(bool){
        bytes32 flightKey = getFlightKey(airline, flight, timestamp);
        return flightSuretyData.isInsuredPassenger(flightKey, passenger);
    }
    /********************************************************************************************/
    ...
    */   
                            ...
                            
    {
        ...
        bool success = flightSuretyData.registerAirline(newAddress, name, msg.sender);
...
function buy (address airline, string flight, uint256 timestamp, string passengerName) external payable {
    bytes32 flightKey = getFlightKey(airline, flight, timestamp);
    flightSuretyData.buy.value(msg.value)(flightKey, passengerName, msg.sender);
}
...
interface FlightSuretyData {
    ...
    function registerAirline(address newAddress, string name, address voter) external returns (bool);
    function isInsuredPassenger(bytes32 flightKey, address passenger) external view returns(bool);
    function buy (bytes32 flightKey, string passengerName, address passengerAddress) external payable;
